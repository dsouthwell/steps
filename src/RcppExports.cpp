...
IntegerVector can_source_cell_disperse(int source_y, int source_x, NumericMatrix iterative_population_state, NumericMatrix future_population_state, NumericMatrix carrying_capacity_available, NumericMatrix permeability_map, int n_cells);
RcppExport SEXP _steps_can_source_cell_disperse(SEXP source_ySEXP, SEXP source_xSEXP, SEXP iterative_population_stateSEXP, SEXP future_population_stateSEXP, SEXP carrying_capacity_availableSEXP, SEXP permeability_mapSEXP, SEXP n_cellsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(can_source_cell_disperse(source_y, source_x, iterative_population_state, future_population_state, carrying_capacity_available, permeability_map, n_cells));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_dispersal
List rcpp_dispersal(NumericMatrix starting_population_state, NumericMatrix potential_carrying_capacity, NumericMatrix permeability_map, int mean_cells, double dispersal_proportion);
RcppExport SEXP _steps_rcpp_dispersal(SEXP starting_population_stateSEXP, SEXP potential_carrying_capacitySEXP, SEXP permeability_mapSEXP, SEXP mean_cellsSEXP, SEXP dispersal_proportionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type permeability_map(permeability_mapSEXP);
    Rcpp::traits::input_parameter< int >::type mean_cells(mean_cellsSEXP);
    Rcpp::traits::input_parameter< double >::type dispersal_proportion(dispersal_proportionSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_dispersal(starting_population_state, potential_carrying_capacity, permeability_map, mean_cells, dispersal_proportion));
    return rcpp_result_gen;
END_RCPP
}
// fast_match
